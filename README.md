...
| Backend                                                        | Frontend                                                | Databases                                                       | CI/CD & Containerização                        | 
| :------------------------------------------------------------: | :-----------------------------------------------------: | :-------------------------------------------------------------: | :---------------------------: |
...
<div align="center">
  <picture>
    ...
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/geisivanvitena/geisivanvitena/output/github-contribution-grid-snake.svg">
